...
export default function Modal({ modal, projects }) {
  ...
  return (
    <>
      ...
      <motion.div
        ref={cursor}
        className="w-[80px] h-[80px] rounded-full bg-primary-200 color-white absolute z-[1] flex items-center justify-center text-[14px] font-light pointer-events-none"
        variants={scaleAnimation}
        initial="initial"
        animate={active ? "enter" : "closed"}
      ></motion.div>
